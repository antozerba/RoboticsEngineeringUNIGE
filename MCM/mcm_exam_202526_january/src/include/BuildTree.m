...
iTj(3,1,1) = 0; iTj(3,2,1) = 0; iTj(3,3,1) = 1; iTj(3,4,1) = 0.1283;
...
iTj(3,1,2) = 0; iTj(3,2,2) = 1;  iTj(3,3,2) = 0; iTj(3,4,2) = 0.115;
iTj(4,1,2) = 0; iTj(4,2,2) = 0;  iTj(4,3,2) = 0; iTj(4,4,2) = 1;

iTj(1,1,3) = 0; iTj(1,2,3) = 1; iTj(1,3,3) = 0;  iTj(1,4,3) = 0;
iTj(2,1,3) = 1; iTj(2,2,3) = 0; iTj(2,3,3) = 0;  iTj(2,4,3) = 0.280;
...
iTj(2,1,4) = 1; iTj(2,2,4) = 0;  iTj(2,3,4) = 0; iTj(2,4,4) = 0;
iTj(3,1,4) = 0; iTj(3,2,4) = 1;  iTj(3,3,4) = 0; iTj(3,4,4) = 0.020;
...
iTj(3,1,5) = 0; iTj(3,2,5) = 1; iTj(3,3,5) = 0;  iTj(3,4,5) = 0.245;
...
iTj(3,1,6) = 0; iTj(3,2,6) = 1;  iTj(3,3,6) = 0; iTj(3,4,6) = 0.028;
...
iTj(3,1,7) = 0; iTj(3,2,7) = 0;  iTj(3,3,7) = 1; iTj(3,4,7) = 0.105;
